...
async function registrarUsuario() {
    ...
    try {
        const response = await fetch("https://easygenapp-de607d464285.herokuapp.com/register", {
            method: "POST",
...
async function iniciarSesion() {
    ...
    try {
        const response = await fetch("https://easygenapp-de607d464285.herokuapp.com/login", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
...
async function generarCodigo() {
    ...
    try {
        const response = await fetch("https://easygenapp-de607d464285.herokuapp.com/generar_codigo", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
